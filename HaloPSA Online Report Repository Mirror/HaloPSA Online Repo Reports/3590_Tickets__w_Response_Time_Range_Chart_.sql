SELECT
    ...
    symptom2 AS [Details],
    CASE 
        WHEN fresponsetime >= 0 AND fresponsetime < .25 THEN N'0-15 Minutes'
        WHEN fresponsetime >= .25 AND fresponsetime < .5 THEN N'15-30 Minutes'
        WHEN fresponsetime >= .5 AND fresponsetime < 1 THEN N'30-60 Minutes'
        WHEN fresponsetime >= 1 AND fresponsetime < 2 THEN N'1-2 Hours'
        WHEN fresponsetime >= 2 THEN N'>2 Hours'
        END AS [Response Time Range]
FROM faults
