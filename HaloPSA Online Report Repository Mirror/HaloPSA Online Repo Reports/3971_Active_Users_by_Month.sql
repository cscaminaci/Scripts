...
left join area on sarea=aarea WHERE UInactive = 'False' AND USite <> 0 and Aisinactive = 'FALSE' and Sisinactive = 'FALSE' and uusername not like 'General User')            AS [Count Now],

(SELECT COUNT(UID) FROM Users left join site on usite=ssitenum
left join area on sarea=aarea WHERE UInactive = 'False' AND USite <> 0 and Aisinactive = 'FALSE' and Sisinactive = 'FALSE' and uusername not like 'General User') -                   /*Count now...*/
...
(SELECT COUNT(UID) FROM Users left join site on usite=ssitenum
left join area on sarea=aarea WHERE UInactive = 'False' AND USite <> 0 and Aisinactive = 'FALSE' and Sisinactive = 'FALSE' and uusername not like 'General User') -           /*Remainder just accounts for additional months*/
