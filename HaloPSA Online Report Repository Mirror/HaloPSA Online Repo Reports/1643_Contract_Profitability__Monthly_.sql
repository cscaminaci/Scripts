select 
	...
	, isnull(round(sum([Monthly Revenue]),2),0) - isnull([Average Monthly Cost (Last 12 Months) (£)],0) as [Average Monthly Profit (£)]
...
where chstatus=3
group by aareadesc,chbillingperiod,CHPeriodChargeAmount,fvalue)z
group by [Customer],[Average Monthly Cost (Last 12 Months) (£)],[Contract Type]
